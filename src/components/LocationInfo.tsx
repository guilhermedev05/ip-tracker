        ...
        <>
            {locationCtx?.ipLocation && !locationCtx.isLoading &&
                <div className="flex flex-col font-['rubik'] md:flex-row bg-white w-full max-w-[267px] md:w-[80%] md:mx-auto md:max-w-5xl md:justify-center py-5 text-center rounded-lg mt-5 absolute top-[45%] md:top-[70%] z-50 md:shadow-md">
                    <div className="flex-1 border-r border-r-gray-200 md:text-left md:px-5 mb-2.5 md:mb-0 md:gap-0">
                    ...
                    <div className="flex-1 border-r border-r-gray-200 md:text-left md:px-5 mb-2.5 md:mb-0">
                    ...
                    <div className="flex-1 border-r border-r-gray-200 md:text-left md:px-5 mb-2.5 md:mb-0">
                        ...
                        <p className="text-gray-700 font-bold">UTC {locationCtx?.ipLocation.location.timezone}</p>
                    </div>
