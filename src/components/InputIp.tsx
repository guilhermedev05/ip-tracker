...
export const InputIp = () => {
    ...
    return (
        <div className="flex w-full max-w-md">
            <input type="text" placeholder="Search for any IP Adress or domain" value={inputIp} onChange={e => setInputIp(e.target.value)} className="bg-white py-2 px-4 md:p-4 rounded-xl text-black rounded-se-none rounded-ee-none w-full outline-none focus:shadow focus:shadow-gray-500 transition-all duration-200 ease-in" />
